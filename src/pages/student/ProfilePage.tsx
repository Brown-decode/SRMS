...
import { studentService, Student } from "@/services/api/students";
...
export const ProfilePage: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const [profile, classInfo] = await Promise.all([
        studentService.getMyProfile(),
        studentService.getMyClass(),
      ]);
  ...
  const handleSettingChange = (key: keyof UserSettings, value: any) => {
    ...
    localStorage.setItem("student_settings", JSON.stringify(newSettings));
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* Tab Content */}
        {activeTab === "profile" && profileData && classData && (
          <Card>
            <CardHeader>
